...
DIR = '/data/data_repo/castrocp/SSC_pipeline/phase3-2/FamilyVCFs/combined_chroms/'
OUT_DIR = '/data/data_repo/castrocp/SSC_pipeline/phase3-2/Candidate_DeNovo/VCF/'
ID_MAP = '/data/data_repo/castrocp/SSC_pipeline/ID_mapping/ssc_phase3-2_quads_id_mapping.txt'
