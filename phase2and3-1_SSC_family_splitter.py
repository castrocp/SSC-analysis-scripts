...
DIR_TO_SPLIT = '/data/data_repo/castrocp/SSC_pipeline/phase2and3-1/GenoRefinement/Fams' + fams + '/'

subprocess.run(['mkdir', '/data/data_repo/castrocp/SSC_pipeline/phase2and3-1/FamilyVCFs/Fams' + fams + '/'])
OUT_DIR = '/data/data_repo/castrocp/SSC_pipeline/phase2and3-1/FamilyVCFs/Fams' + fams + '/'
